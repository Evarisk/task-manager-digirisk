<?php namespace task_manager_digirisk;
...
<div class="wrap wpeo-logs-wrap">
	...
	if ( !empty( $action ) && 'edit' == $action ):
		require ( PLUGIN_TASK_MANAGER_DIGIRISK_PATH . config_util::$init['wpeo_log']->path . '/view/list-service-edit.view.php' );
	elseif ( !empty( $action ) && 'view' == $action ):
		require ( PLUGIN_TASK_MANAGER_DIGIRISK_PATH . config_util::$init['wpeo_log']->path . '/view/view-service.view.php' );
		require ( PLUGIN_TASK_MANAGER_DIGIRISK_PATH . config_util::$init['wpeo_log']->path . '/view/chart.view.php' );
	else:
		require ( PLUGIN_TASK_MANAGER_DIGIRISK_PATH . config_util::$init['wpeo_log']->path . '/view/list-service.view.php' );
	endif;
	?>
</div>
